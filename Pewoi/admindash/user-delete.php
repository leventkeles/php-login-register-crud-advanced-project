        ...
        <ul class="nav">
          ...
          <li class="nav-item active">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item active"> <a class="nav-link" href="user-delete.php">Kullanıcı Sil</a></li>
  ...
  <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Kullanıcı İşlemleri</h4>
                  <p class="card-description">
                    Bu tablodan herhangi bir kullanıcıyı görüntüleyebilir, silebilirsiniz.
                  </p>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <button type="button" class="btn btn-info btn-sm">Detay</button>
